    ...
    <div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
        <div class="container-fluid">
            ...
            <div class="navbar-brand flex-1 flex-lg-0 text-center">
                <a href="index" class="d-inline-flex align-items-center">
                    <img src="{{URL::asset('assets/images/imageicon.png')}}" class="text-center" style="height: 50px; width:50px;" alt="">
                    <span class="fw-bold text-white h4 text-center mt-2 ms-2 text-uppercase"> Workfolio</span>
